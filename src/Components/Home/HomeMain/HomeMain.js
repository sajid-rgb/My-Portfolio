...
const HomeMain = () => {
    ...
    return (
      ...
      /></span>
                 ...
                 <p className="text-dark">I am a professional MERN Stack developer. I love to work and learn new things</p>
                 ...
                 <button className=" btn btn-primary ml-3">Hire Me</button>
                 </a>
